...
const LogisticBlob: React.FC<LogisticBlobProps> = ({ width = 430, height = 440, style, className = "" }: LogisticBlobProps) => {
    return (
        <View style={style}>
            <Svg width={width} height={height} className={className} viewBox="0 0 430 440" fill="none">
