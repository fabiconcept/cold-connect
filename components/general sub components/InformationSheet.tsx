...
const ExpandableCard = ({
    ...
    return (
        <PanGestureHandler onGestureEvent={gestureHandler}>
            <Animated.View
                style={[animatedStyle]}
                className={`w-full bg-white rounded-t-[40px] px-3 pt-12 pb-5 overflow-hidden absolute bottom-0 shadow-lg shadow-black/10 ${className}`}
            >
                <View hitSlop={20} className='absolute top-0 left-0 w-screen h-8 gap-1 rounded-[40px] bg-gray-100 justify-center items-center'>
